...
namespace School
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            // Save the changes by calling the SaveChanges method of the schoolContext object
            try
            {
            ...
            // If an OptimisticConcurrencyException occurs then another user has changed the same students earlier, then overwrite their changes with the new data (see the lab instructions for details)
            catch (OptimisticConcurrencyException)
            {
                this.schoolContext.Refresh(RefreshMode.StoreWins, schoolContext.Students);
                this.schoolContext.SaveChanges();
            }
            // If an UpdateException occurs then report the error to the user and rollback (see the lab instructions for details)
            ...
            // If some other sort of error has occurs, report the error to the user and retain the data so the user can try again - the error may be transitory (see the lab instructions for details)
            catch (Exception ex)
            {
